...
//        int[] unsortedArray = {1, 4, 5, 2, 3};
        ...
        useQuickSort(unsortedArray.clone(), 0, unsortedArray.length - 1);
        ...
        CountingSort.useCountingSort(unsortedArray.clone());
        ...
        System.out.println("Counting Sort Frequency Count: " + CountingSort.counter);
